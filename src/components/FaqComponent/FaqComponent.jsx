...
const FaqComponent = () => {
  ...
  function QA(props) {
    return (
      <div className="QA">
        <h2 id={props.qNo} className="pb-2 pr-2 text-[22px] font-bold
  ...
  return (
    <div className='min-h-full mx-10 md:mx-52 mt-10 lg:mb-28 mb-5'>
      ...
      <div className="questions&answers">
        <h1
          className="text-3xl lg:text-4xl font-bold text-[#000f38] mb-6 text-center lg:text-left"
        >Frequently Asked Questions</h1>

        <p>We’ve received a lot of great questions over the years. Here are some the questions we hear most often.</p>

        <div className="faqCat">What is My Interview Practice?</div>

        <QA question="What is the Interview Simulator, and how does it work? "
        ...
        />
        <QA question="Where do you get your questions?"
        ...
        />
        <QA question="Can I create my own interview questions?"
        ...
        />
        <QA question="What happens if I need help with the Interview Simulator or with my interview preparation?"
        ...
        <QA question="I don’t have a lot of experience interviewing. How will this tool help me? "
          ...
          rotator={displayAnswer1}
        />
        <QA question="I am an experienced interviewer. How will this tool help me?"
          ...
          rotator={displayAnswer2}
        />
        <QA question="Why should I use this tool as opposed to just finding questions online?"
          ...
          rotator={displayAnswer3}
        />
        <QA question="I’m a professor (or other organization representative) that would like to introduce this tool to our students and/or members. Do you offer bulk rates?"
        ...
        <QA question="What are the different types of interviews I can take? "
          ...
          rotator={displayAnswer1}
        />
        <QA question="What industries and positions can I practice with in the tool? What if I do not find my position?"
          ...
          rotator={displayAnswer2}
        />
        <QA question="If I don’t like the Premium Membership can I get my money back?"
          ...
          rotator={displayAnswer3}
        />
        <QA question="What are the computer requirements (hardware/software) to use the tool?"

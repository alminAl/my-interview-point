    ...
    <div className="w-full mb-20 flex justify-center items-center">
      <div className="bg-white w-full md:w-1/2 flex flex-col items-center py-6 px-8">
        ...
        >
          ...
          <button class="tracking-wide font-semibold bg-[#E7303E] text-gray-100 w-full py-4 rounded-lg hover:bg-[#eb0619] transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
            <svg
              class="w-6 h-6 -ml-2"
              fill="none"
              stroke="currentColor"

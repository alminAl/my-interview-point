...
const Footer = () => {
    return (
        <footer className="text-center bg-gray-900 mt-24 text-white">
            <div>
                ...
                <div className="flex justify-center items-center my-3">
                    ...
                    <a href="#!" type="button" className="rounded-full border-2 mx-3 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                        <svg aria-hidden="true"
                            focusable="false"
                            data-prefix="fab"
                            data-icon="twitter"

        ...
        <div className='min-h-full mx-5 md:mx-44 mt-10 lg:mb-28 mb-5'>
            <div className='flex-col lg:flex lg:flex-row justify-center items-center'>
                <div className='lg:mr-5 mb-5 lg:mb-0 w-full lg:w-96 '>
                    <p className='tracking-wider text-center lg:text-left text-base'>FOR CAREER ADVISORS</p>
                    ...
                    <p className="mb-6 text-base lg:text-lg font-semibold text-center lg:text-left">Provide simulated interviews they can conduct on their own. No need to schedule, commute, or meet in person.</p>
